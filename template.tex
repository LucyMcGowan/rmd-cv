...
\usepackage[left=6.1cm,top=2cm,right=1.5cm,bottom=2.5cm,nohead]{geometry}
...
$for(work)$
 \begin{tabular}{p{3.5cm} p{10.25cm}}
...
$endfor$
\newgeometry{left=2cm,top=2cm,right=2cm,bottom=2.25cm}
